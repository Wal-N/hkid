...
public final class ResourceJson {
    ...
    /**
     * Strictly parses a bundled UTF-8 JSON resource whose root is an object.
     *
     * @param resourceName classpath-relative JSON resource name
     * @return the parsed root object
     * @throws IllegalArgumentException if the resource name is null or blank
     * @throws IllegalStateException if the resource is missing, malformed, unreadable,
     *         or does not contain an object root
     */
    ...
    /**
     * Requires an object to contain exactly the supplied keys.
     *
     * @param object object whose keys are validated
     * @param context human-readable location included in error messages
     * @param expectedKeys complete set of required key names
     * @throws IllegalArgumentException if {@code expectedKeys} contains duplicates
     * @throws IllegalStateException if a required key is missing or an extra key is present
     */
    ...
    /**
     * Reads a required, non-null object field.
     *
     * @param parent object containing the field
     * @param name field name
     * @param context human-readable location included in error messages
     * @return the object field value
     * @throws IllegalStateException if the field is missing, null, or not an object
     */
    ...
    /**
     * Reads a required field that may contain either an object or JSON null.
     *
     * @param parent object containing the field
     * @param name field name
     * @param context human-readable location included in error messages
     * @return the object field value, or {@code null} for JSON null
     * @throws IllegalStateException if the field is missing or has another type
     */
    ...
    /**
     * Reads a required, non-null array field.
     *
     * @param parent object containing the field
     * @param name field name
     * @param context human-readable location included in error messages
     * @return the array field value
     * @throws IllegalStateException if the field is missing, null, or not an array
     */
    ...
    /**
     * Reads a required, non-null string field.
     *
     * @param parent object containing the field
     * @param name field name
     * @param context human-readable location included in error messages
     * @return the string field value
     * @throws IllegalStateException if the field is missing, null, or not a string
     */
    ...
    /**
     * Reads a required field that may contain either a string or JSON null.
     *
     * @param parent object containing the field
     * @param name field name
     * @param context human-readable location included in error messages
     * @return the string field value, or {@code null} for JSON null
     * @throws IllegalStateException if the field is missing or has another type
     */
    ...
    /**
     * Reads a required integer field without accepting fractional or exponent notation.
     *
     * @param parent object containing the field
     * @param name field name
     * @param context human-readable location included in error messages
     * @return the integer field value
     * @throws IllegalStateException if the field is missing, null, not an integer,
     *         or outside the {@code int} range
     */
